...
public class Hyunday extends Stock {
	
	final int basePrice = 7500;
	...
	public void showClientBalance() {
		...
		System.out.println("=====고객님이 갖고 계신 Hyunday 의 자산은 "+ this.clientBalance + "원=====");
	}

	@Override
	public void show() {
		System.out.printf(" %4s  %4d  %4d ", "Hyunday", this.presentPrice, this.change);
	}
	...
	public void changeValue() {
		...
		if(updown == 0) {
			...
			if(this.presentPrice <= 0) {
				System.out.println("Hyunday가 파산하였습니다. 가진 주식을 모두 잃게 됩니다.");
				pasan = true;
			}
		}
	}
