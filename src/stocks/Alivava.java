...
public class Alivava extends Stock{
	final int basePrice = 2500;
	...
	public void showClientBalance() {
		...
		System.out.println("=====고객님이 갖고 계신 Alivava 의 자산은 "+ this.clientBalance + "원=====");
	}

	@Override
	public void show() {
		System.out.printf(" %4s  %4d  %4d ", "Alivava", this.presentPrice, this.change);
	}
	...
	public void changeValue() {
		...
		int value = (int)(Math.random()*400+100);
		this.change = value;
		...
		if(updown == 0) {
			...
			if(this.presentPrice <= 0) {
				System.out.println("Alivava가 파산하였습니다. 가진 주식을 모두 잃게 됩니다.");
				pasan = true;
			}
		}
	}
